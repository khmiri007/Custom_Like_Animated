...
/**
 * Created by zied216 on 19/05/2017.
 */
...
public class LikeAnim extends View {
    ...
    public LikeAnim(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public LikeAnim(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public LikeAnim(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        init(attrs, defStyleAttr);
    }

    public static LikeAnim attach2Window(Activity activity) {
        ViewGroup rootView = (ViewGroup) activity.findViewById(Window.ID_ANDROID_CONTENT);
        LikeAnim smallBang = new LikeAnim(activity);
     ...
     * @param listener
     */
    public void setmListener(LikeAnimListener listener) {
    ...
    public void anim(final View view, LikeAnimListener listener) {
        anim(view, -1, listener);
    }

    public void anim(final View view, float radius, LikeAnimListener listener) {
